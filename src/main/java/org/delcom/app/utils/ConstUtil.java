...
public class ConstUtil {
    ...
    public static final String TEMPLATE_AUTH_LOGIN = "pages/auth/login";
    ...
    public static final String TEMPLATE_ORDER_LIST = "pages/orders/list";
    public static final String TEMPLATE_ORDER_FORM = "pages/orders/form-create";
}